                    ...
                    <div x-show="!showLogin">
                        ...
                        <div>
                            ...
                            <div x-data="{ showPassword: false }" class="relative">
                                ...
                                <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 z-10 -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700">
                        ...
                        <div>
                            ...
                            <div x-data="{ showLoginPassword: false }" class="relative">
                                <input :type="showLoginPassword ? 'text' : 'password'" id="login_password" name="password" required
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" />
                                <button type="button" @click="showLoginPassword = !showLoginPassword" class="absolute right-3 top-1/2 z-10 -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700">
